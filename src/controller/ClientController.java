...
public class ClientController {
        ...
        public void registerClient(String direction, String name, String dni, String mail, String phone, String password) {
            clientsList.add(new Client(ThreadLocalRandom.current().nextInt(999999), mail, name, dni, mail, phone, password));
        }
