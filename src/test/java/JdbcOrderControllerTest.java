 ...
 * as well as for managing order lines and customer-specific orders.
 */
public class JdbcOrderControllerTest {
     ...
     * </p>
     */
    public JdbcOrderControllerTest() {
        // Empty constructor
    }

    /**
     * Initializes the test environment before each test.
     * This includes resetting the database, initializing controllers, and registering customers.
     *
    ...
    /**
     * Tests adding a product to the customer's cart.
     *
     * @throws SQLException if a database error occurs.
     */
    @Test
    ...
    /**
     * Tests selecting orders by customer.
     *
     * @throws SQLException if a database error occurs.
     */
    @Test
    void testselectOrdersByCustomer() throws SQLException, ParseException {
        ...
        assertEquals(customer1, order.getCustomer(), "The customer should match");
    ...
    /**
     * Tests selecting orders by their state for a specific customer.
     *
     * @throws SQLException if a database error occurs.
     */
    @Test
    ...
    /**
     * Tests canceling an order for a customer.
     *
     * @throws SQLException if a database error occurs.
     */
    @Test
